  ...
  return (
    <>
      {tags.map((tag) => (
        <div
          key={tag}
          className="flex items-center text-xs font-medium px-2 py-0.5 rounded border dark:border-neutral-500 dark:text-neutral-200 bg-neutral-200 border-neutral-300 dark:bg-neutral-950 dark:hover:border-neutral-600"
        >
          {tag}
        </div>
      ))}{" "}
...
export default function Project({
  ...
  return (
    <div className="flex sm:w-80 rounded-md border shadow-lg dark:shadow-neutral-800/50 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:border-neutral-500">
